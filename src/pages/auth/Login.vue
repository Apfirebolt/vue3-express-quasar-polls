<template>
  <div class="row items-center justify-evenly">
    <div class="col-8">
      <p class="text-center text-h5 text-blue-5 q-my-md">LOGIN</p>
...
import { LoginPayload, LoginPayloadSchema } from '../../composables/auth/model';
...
export default defineComponent({
  ...
  setup() {
    ...
    const { handleSubmit, isSubmitting, errors } = useForm<LoginPayload>({
      validationSchema,
    });
